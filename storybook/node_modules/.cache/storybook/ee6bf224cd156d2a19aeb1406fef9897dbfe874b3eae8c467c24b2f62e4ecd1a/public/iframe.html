    ...
    console.warn('unable to connect to top frame for connecting dev tools');
      ...
      #storybook-docs[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./src","files":"**/*.mdx","importPathMatcher":"^\\.[\\\\/](?:src(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.mdx)$"},{"titlePrefix":"","directory":"./src","files":"**/*.stories.@(json|yaml|yml)","importPathMatcher":"^\\.[\\\\/](?:src(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.(json|yaml|yml))$"},{"titlePrefix":"","directory":"../web/themes/custom","files":"**/*.stories.@(json|yaml|yml)","importPathMatcher":"^(?:\\.\\.\\/web\\/themes\\/custom(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.(json|yaml|yml))$"}];
      ...
      import './vendors-node_modules_storybook_addon-essentials_dist_actions_preview_mjs-node_modules_storybo-6ac65e.iframe.bundle.js';
