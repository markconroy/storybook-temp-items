import type { Formatter, FormatterPathType } from 'fork-ts-checker-webpack-plugin/lib/formatter/formatter';
import type { BabelCodeFrameOptions } from 'fork-ts-checker-webpack-plugin/lib/formatter/types/babel__code-frame';
